<section>
    ...
    <!-- Verification Form (if necessary) -->
    <form id="send-verification" method="post" action="{{ route('verification.send') }}">
        @csrf
    </form>

    <!-- Profile Update Form -->
    <form method="post" action="{{ route('owner.update') }}" enctype="multipart/form-data" class="mt-6">
        @csrf
        @method('patch')
            ...
            <div class="col-md-6">
                ...
                <div>
                    ...
                    @if ($user->profile_photo)
                        <div class="mt-2">
                            <img src="{{ asset('storage/' . $user->profile_photo) }}" alt="Profile Photo" class="rounded-full h-40 w-40 object-cover">
                        </div>
                    @endif
                    ...
                    <div class="mt-4">
                        ...
                        <img id="preview" class="object-cover" alt="Preview Image" style="max-height: 200px; max-width: 100%;">
                    </div>
                </div>
            </div>
        </div>
